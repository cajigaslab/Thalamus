...
# "Signal Lab" brand colors wired into Furo's CSS variables (custom.css adds the
# typography and the rest of the polish).
html_theme_options = {
    ...
    'footer_icons': [
        {
            'name': 'GitHub',
            'url': 'https://github.com/cajigaslab/Thalamus',
