...
ChessBoardNode::ChessBoardNode(ObservableDictPtr state,
                               boost::asio::io_context &io_context,
                               NodeGraph *graph)
...
size_t ChessBoardNode::num_planes() const { return 1; }

ImageNode::Format ChessBoardNode::format() const {
  return ImageNode::Format::Gray;
}

size_t ChessBoardNode::width() const { return size_t(impl->stride); }
...
std::chrono::nanoseconds ChessBoardNode::frame_interval() const { return 16ms; }

bool ChessBoardNode::prepare() { return true; }

bool ChessBoardNode::has_image_data() const { return true; }
