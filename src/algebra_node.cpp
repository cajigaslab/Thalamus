...
int AlgebraNode::num_channels() const { return int(impl->data.size()); }
...
size_t AlgebraNode::modalities() const {
  return infer_modalities<AlgebraNode>();
}
} // namespace thalamus
