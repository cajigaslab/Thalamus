...
namespace thalamus {
class SerialTouchScreenNode : public Node, public AnalogNode {
  struct Impl;
  std::unique_ptr<Impl> impl;

public:
  SerialTouchScreenNode(ObservableDictPtr state, boost::asio::io_context &io_context,
                  NodeGraph *);
  ~SerialTouchScreenNode() override;
