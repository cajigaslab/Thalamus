...
namespace thalamus {
class SampleMonitorNode : public Node, public AnalogNode {
  struct Impl;
  std::unique_ptr<Impl> impl;

public:
  SampleMonitorNode(ObservableDictPtr state, boost::asio::io_context &io_context,
          NodeGraph *);
  ~SampleMonitorNode() override;
