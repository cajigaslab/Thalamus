...
import ctypes
_EXTENSION_NAME = 'GLES2_OES_EGL_image_external'
def _f( function ):
    return _p.createFunction( function,_p.PLATFORM.GLES2,'GLES2_OES_EGL_image_external',error_checker=_errors._error_checker)
